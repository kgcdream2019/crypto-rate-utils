...
const getRate = (
  ...
  // newly added code for ethB
  let sourceSymbol = source.symbol
  let destSymbol = dest.symbol
  if(sourceSymbol === "ETHB"){
    sourceSymbol = "ETH"
  }
  else if(sourceSymbol === "ethb" || sourceSymbol === "ethB") {
    sourceSymbol = "ETH"
  }
  if(destSymbol === "ETHB"){
    destSymbol = "ETH"
  }
  else if(destSymbol === "ethb" || destSymbol === "ethB") {
    destSymbol = "ETH"
  }
  // end
  ...
  if (sourceSymbol !== destSymbol) {
    ...
    const sourcePrice = api.getPrice(sourceSymbol)
    const destPrice = api.getPrice(destSymbol)
